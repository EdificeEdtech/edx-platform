...
def run_quality(options):
    ...
    if not run_diff_quality(
        ...
        diff_quality_pass = False
        failure_reasons.append('Pylint violations in the code that was added or changed.')
    ...
    if not run_diff_quality(
        ...
        diff_quality_pass = False
        failure_reasons.append('Eslint violations in the code that was added or changed.')
